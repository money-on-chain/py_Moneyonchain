...
#0x483B48e5b7f1475047b2b54F6B47Ef1E31983e92
account_address = '0x483B48e5b7f1475047b2b54F6B47Ef1E31983e92'
...
print("Balance: {0} {1}".format(moc_token.balance_of(account_address, block_identifier=2292933), moc_token.symbol()))
print("Allowance: {0} {1}".format(moc_token.allowance(account_address, moc_address, block_identifier=2292933), moc_token.symbol()))
