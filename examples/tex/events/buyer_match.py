...
from moneyonchain.tex import MoCDecentralizedExchange, DEXBuyerMatch
...
hours_delta = 0
from_block = 1528540  # from block start
to_block = 1528550  # block end or 0 to last block
block_steps = 1000
...
if l_events:
    ...
    path_file = '{0}_buyer_match_{1}_{2}.csv'.format(config_network, from_block, to_block)
