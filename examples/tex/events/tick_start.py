...
from moneyonchain.tex import MoCDecentralizedExchange, DEXTickStart
...
events_functions = 'TickStart'
hours_delta = 0
from_block = 3380543  # from block start
to_block = 3385543  # block end or 0 to last block
block_steps = 1000
...
if l_events:
    columns = DEXTickStart.columns()
    path_file = '{0}_tick_start_{1}_{2}.csv'.format(config_network, from_block, to_block)
