...
from moneyonchain.tex import MoCDecentralizedExchange, DEXTickEnd
...
if l_events:
    ...
    path_file = '{0}_tick_end_{1}_{2}.csv'.format(config_network, from_block, to_block)
